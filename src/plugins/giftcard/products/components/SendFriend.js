            ...
            <View>
                ...
                <View style={{marginTop : 15, marginBottom: 15}}>
                    <ListItem onPress={() => this.updateCheck(3)}>
                        <Icon name={this.state.notif ? 'ios-checkmark-circle-outline' : 'ios-radio-button-off'} />
                        <Body>
                        <Text
                            style={{ marginStart: 7}}
        ...
        post_office = this.parent.state.data.simigiftcard.simigiftcard_settings.simigift_postoffice === "1" ?
            ...
            >
                <ListItem onPress={() => this.updateCheck(1)}>
                    <Icon name={this.state.post_office ? 'ios-checkmark-circle-outline' : 'ios-radio-button-off'} />
                    <Body>
                    <Text
            ...
            >
                ...
                >
                    <ListItem onPress={() => this.updateCheck(2)}>
                        <Icon name={this.state.via_email ? 'ios-checkmark-circle-outline' : 'ios-radio-button-off'} />
                        <Body>
                        <Text
                            style={{fontSize : 16, marginStart: 7}}
                        >
