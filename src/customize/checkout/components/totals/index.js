    ...
    renderView() {
        ...
        if (data) {
            ...
            if (this.tax_cart_display_subtotal === 1 && data.subtotal_excl_tax) {
                subtotal = (
                    <View style={this.props.styleSubTotal}>
...
Totals.defaultProps = {
    ...
    //one row.
    styleOneRowPrice: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10 },
    styleSubTotal: { flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#e0e0e0' },
    styleTwoRowPrice: { flex: 1, flexDirection: 'column', justifyContent: 'space-between' },
    styleMargin: { marginLeft: 20, marginRight: 10, marginBottom: 0, marginTop: 20 },
    type: 0,
