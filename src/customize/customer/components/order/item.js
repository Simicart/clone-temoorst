...
const OrderBilling = (props) => {
    ...
    function renderOrderNumber() {
        return (
            <CardItem style = {{ paddingTop: 5, paddingBottom: 5, marginBottom: 10, flexDirection: 'row', alignSelf: 'flex-start' }} listItemPadding={0}>
                <View style={{ flexDirection: 'row', marginRight: 5 }}>
                    <Text style={{ fontFamily: material.fontBold, fontSize: 16 }}>{Identify.__('Order ID')}</Text>
                    <Text style={{ fontFamily: material.fontBold, color: '#595656'}}>:</Text>
                </View>
    ...
    function renderDate() {
        return (
            <CardItem style = {{ flexDirection: 'row', alignSelf: 'flex-start', paddingTop: 5, paddingBottom: 5 }} listItemPadding={0}>
                <View style={{ flexDirection: 'row', marginRight: 5 }}>
